...
<p align="center">
  ...
  <a href="#-the-certified-gap--one-formula-for-every-certificate">Certified gap</a> ·
...
above an explicit floor. Name that functional the **certified gap**:
...
> 🧭 **Boundary:** the certified gap is a *unifying bookkeeping functional over verified finite
...
- [`docs/certified-gap.md`](docs/certified-gap.md) — the certified gap, the one formula unifying every track's certificate
