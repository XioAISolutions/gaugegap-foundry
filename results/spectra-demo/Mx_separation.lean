...
namespace CurveRankCertified.XpN20
...
/-- TRUST INPUT — interval-arithmetic certificate (external to Lean, produced by
    ...
    zeta-zero enclosures): `M ≥ 35.5356899424466`. This is the single axiom; everything
    below is discharged by Lean. -/
axiom certified_lower_bound : M ≥ 35.5356899424466
