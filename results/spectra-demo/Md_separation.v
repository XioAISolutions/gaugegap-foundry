...
Section CurveRankCertified_dirac_rindler_n20.

(* Certified L2 spectral mismatch between the Dirac-Rindler truncation (n = 20) and
   the first 20 Riemann zeros; abstract real. *)
Variable M : R.

(* TRUST INPUT: interval-arithmetic certificate (external to Coq). *)
Hypothesis certified_lower_bound : M >= 26.191066278053995.
...
End CurveRankCertified_dirac_rindler_n20.
