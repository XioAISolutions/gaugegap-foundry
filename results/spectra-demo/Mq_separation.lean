...
namespace CurveRankCertified.QuantumGraphN20
...
/-- TRUST INPUT — interval-arithmetic certificate (external to Lean, produced by
    ...
    zeta-zero enclosures): `M ≥ 76.1657160545473`. This is the single axiom; everything
    below is discharged by Lean. -/
axiom certified_lower_bound : M ≥ 76.1657160545473
...
end CurveRankCertified.QuantumGraphN20
