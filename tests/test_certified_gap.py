"""Tests for the unified certified gap formula (certifiedgap-0001).
...
from gaugegap.certified_gap import (
    CertifiedGap,
...
def test_certificate_has_no_holes():
    ...
    assert "theorem certified_gap_pos" in lean
    assert "Theorem certified_gap_pos" in coq
