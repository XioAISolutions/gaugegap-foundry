...
def main() -> int:
    ...
    parser.add_argument("--hypothesis-id", default="gaugegap-0003")
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT / "results" / "gaugegap-0003")
    ...
    candidates_path = args.output_dir / "gaugegap-0003-candidates.jsonl"
    write_jsonl(candidates_path, candidates)
    (args.output_dir / "gaugegap-0003-candidates.json").write_text(
        json.dumps(candidates, indent=2, sort_keys=True, default=str) + "\n", encoding="utf-8"
    )
    write_csv(args.output_dir / "gaugegap-0003-ranking.csv", candidates)
    write_markdown_summary(args.output_dir / "gaugegap-0003-ranking.md", candidates)
