...
CURATED_DOCS = [
    ...
    ("docs/anharmonic-certified.md", "04-anharmonic-certified.md",
     "Certified two-sided bounds for the quartic anharmonic oscillator"),
    ("docs/double-well-certified.md", "04b-double-well-certified.md",
     "Certified enclosures + tunnelling splitting for the symmetric double well"),
