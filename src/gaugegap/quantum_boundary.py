...
SURFACES: tuple[QuantumSurface, ...] = (
    QuantumSurface(
        ...
        files=(
            "scripts/run_gap_sweep.py",
            "scripts/run_z2_plaquette.py",
            "scripts/run_gaugegap_u1.py",
            "scripts/run_flowgap_burgers.py",
            "scripts/run_curverank_screen.py",
        ),
    ...
    QuantumSurface(
        ...
        actual_quantum_hardware=False,
        files=(
            "src/gaugegap/qiskit_backend.py",
            "src/gaugegap/quantum/pauli_export.py",
            "scripts/run_gap_sweep.py",
            "scripts/run_quantum_gap_replica.py",
        ),
