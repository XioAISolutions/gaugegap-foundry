...
Section CurveRankCertified_xp_n20.

(* Certified L2 spectral mismatch between the Berry-Keating xp truncation (n = 20) and
   the first 20 Riemann zeros; abstract real. *)
Variable M : R.

(* TRUST INPUT: interval-arithmetic certificate (external to Coq). *)
Hypothesis certified_lower_bound : M >= 35.5356899424466.
